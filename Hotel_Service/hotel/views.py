...
def about_or_delete(request, hotel_uid):
    try:
        if request.method == 'GET':
            ...
            hotel_likes = requests.delete("http://litvinov-rating.herokuapp.com/api/v1/rating/delete_hotel",
                               json={'hotel_uid': hotel_uid},
                               cookies=request.COOKIES)
            hotel_comments = requests.delete("http://litvinov-rating.herokuapp.com/api/v1/rating/delete_all_comments",
                               json={'hotel_uid': hotel_uid},
                               cookies=request.COOKIES)
...
def all_hotels_or_add_hotel(request):
    ...
    try:
        if request.method == 'GET':
            ...
            hotel_likes = requests.post("http://litvinov-rating.herokuapp.com/api/v1/rating/create_hotel",
